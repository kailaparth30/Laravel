        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}">Services</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}">Portfolio</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{url('/')}}">Contact</a></li>
                    <li class="nav-item"><a class="nav-link bg-danger p-2 rounded "
                            href="{{url('layout1/home/login')}}">Log
                            in </a></li>
                    <li class="nav-item"><a class="nav-link  ms-2 bg-danger p-2 rounded" href="{{url('layout1/home/register')}}">
                            Register</a></li>
                </ul>
            </div>
        </div>
